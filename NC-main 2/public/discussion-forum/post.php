...
<div class="container">		
					  ...
					  <div class="panel panel-default arrow left">
						<div class="panel-body">
						  <header class="text-left">
							<div class="comment-user"><i class="fa fa-user"></i> De: <?php echo $posterName; ?></div>
						  ...
						  <div class="text-right" id="button_section_<?php echo $post['post_id']; ?>">
							...
							<a class="btn btn-default btn-sm" id="delete_<?php echo $post['post_id']; ?>"><i class="fa fa-reply"></i> Delete</a>
						  </div>
		...
		<article class="row">
			...
			<div class="col-md-10 col-sm-10">
			  <div class="panel panel-default arrow left">
				<div class="panel-body">
				  <header class="text-left">
					<div class="comment-user"><i class="fa fa-user"></i> De: USERNAME</div>
				  ...
				  <div class="text-right" id="button_section_POSTID">
					...
					<a class="btn btn-default btn-sm" id="delete_POSTID"><i class="fa fa-reply"></i> Delete</a>
				  </div>
				 ...
				 <div id="deleteSection_POSTID" class="hidden">						
					<button type="submit" id="save_POSTID" name="save" class="btn btn-info saveButton">Save</button>
					<button type="submit" id="cancel_POSTID" name="cancel" class="btn btn-info saveButton">Cancel</button>
				 </div>	
	...
	<div id="postDeleteHtml" class="hidden">		
			<div class="col-md-2 col-sm-2 hidden-xs">
			  <figure class="thumbnail">
				<img class="img-responsive" src="images/user-avatar.png" />
				<figcaption class="text-center">USERNAME</figcaption>
