						...
						<ul class="w-100 list-group" id="topic-list">
							...
							?>
								<li class="list-group-item mb-4">
									<div>
										<?php if ($_SESSION['login_id'] == $row['user_id'] || $_SESSION['login_type'] == 3 || $_SESSION['login_type'] == 1): ?>
									...
									<span class="float-left badge badge-primary text-white ml-2"><i class="fa fa-comments"></i> <?php echo number_format($view) ?> comentario/s <?php echo $replies > 0 ? " and " . number_format($replies) . ' Respuestas' : '' ?> </span>
