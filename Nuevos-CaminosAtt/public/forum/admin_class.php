...
class Action
{
	...
	function cadastre()
	{
		...
		$password = md5($_POST["password"]);  // Criptografar senha com MD5 (melhor usar bcrypt)
		...
		// Inserir novo usuário no banco de dados com o type = 2
		$qry = "INSERT INTO users (name, username, password, type) VALUES ('$name', '$username', '$password', 2)";
		$insert = $this->db->query($qry);


		if ($insert) {
			// Registrar sessão com dados do usuário recém-criado
			$_SESSION['login_name'] = $name;
			$_SESSION['login_username'] = $username;
			return 1;  // Sucesso
		} else {
			return 3;  // Erro ao inserir no banco de dados
		}
	}
