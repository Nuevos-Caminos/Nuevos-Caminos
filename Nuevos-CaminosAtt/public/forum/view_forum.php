			...
			<div class="card-body">
				<?php if (isset($_SESSION['login_id'], $_SESSION['login_type']) && ($_SESSION['login_id'] || $_SESSION['login_type'] == 1)): ?>
					<div class="dropleft float-right mr-4" style="position: relative;">
						<a class="btn btn-primary edit_topic " data-id="<?php echo $id ?>" href="javascript:void(0)">Editar</a>
					</div>
				<?php endif; ?>
					...
					?>
						<div class="form-group comment">
							...
							<div>
								...
								<span class="text-primary ml-4"><?php echo isset($rep_arr[$row['id']]) ? count($rep_arr[$row['id']]) . (count($rep_arr[$row['id']]) > 1 ? ' Respuestas' : ' Replied') : '' ?></span>
